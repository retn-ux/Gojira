...
typedef NTSTATUS(NTAPI* PfnRtlAdjustPrivilege)(IN ULONG Privilege, IN BOOLEAN Enable, IN BOOLEAN CurrentThread, OUT PBOOLEAN Enabled);
typedef NTSTATUS(NTAPI* PfnZwShutdownSystem)(IN SHUTDOWN_ACTION action);
typedef void(NTAPI* PfnNtRaiseHardError)(IN NTSTATUS, IN ULONG, IN PUNICODE_STRING, IN PVOID, IN HARDERROR_RESPONSE_OPTION, OUT PHARDERROR_RESPONSE);
